      ...
      <AnimatePresence mode="wait">
        ...
        {step === 2 && (
          ...
          >
            ...
            <button
              onClick={() => setStep(1)}
              className="px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-sans font-bold text-xs shadow-lg shadow-emerald-600/20 border border-emerald-400/80 transition-all cursor-pointer flex items-center gap-1.5 mt-2 w-fit"
            >
              ← Previous Step
            </button>
          </motion.div>
